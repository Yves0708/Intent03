...
public class Intent03Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<CharSequence> adapterActions = ArrayAdapter
				.createFromResource(this, R.array.main_menu_array,
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			Class [] target = {
				PhonesActivity.class,ContactsActivity.class,MmsActivity.class,WebsActivity.class,MapsActivity.class	
			};	
			// 用使用者選擇項目編號的Activity元件建立Intent物件
			Intent intent = new Intent(Intent03Activity.this,target[position]);
			// 啟動指定的Activity元件
